 ...
 *
 * @param mode
 *   whether and with what priority a SSL connection will be negotiated, default
 *   disabled
 * @param rootCert
 *   path to PEM encoded trusted root certificates, None to use internal JDK
 *   cacerts, defaults to None
 */
