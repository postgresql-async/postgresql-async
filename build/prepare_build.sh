...
psql -h 127.0.0.1 -d "postgres" -c "CREATE USER postgres_scram WITH PASSWORD 'postgres_scram'; GRANT ALL PRIVILEGES ON DATABASE netty_driver_test to postgres_kerberos;" -U $PGUSER
