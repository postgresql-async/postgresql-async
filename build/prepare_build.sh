...
psql -h 127.0.0.1 -d "postgres" -c "CREATE USER postgres_ssl WITH PASSWORD 'postgres_ssl'; GRANT ALL PRIVILEGES ON DATABASE netty_driver_test to postgres_ssl;" -U $PGUSER
