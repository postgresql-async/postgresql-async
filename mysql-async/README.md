...
- [mysql-async - an async, Netty based, MySQL driver written in Scala 2.12 and 2.13](#mysql-async---an-async-netty-based-mysql-driver-written-in-scala-212-and-213)
...
# mysql-async - an async, Netty based, MySQL driver written in Scala 2.12 and 2.13
